    ...
    public class VideoPlayerActivity extends AppCompatActivity implements YouTubeFetcher.FetchRelatedVideosCallback {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            relatedVideosAdapter = new RelatedVideosAdapter(new ArrayList<>(), contentItem -> {
                String videoId = contentItem.videoRenderer.videoId; // Adjust this according to your data structure
            ...
            if (videoUrl == null || videoUrl.isEmpty()) {
                ...
                // Fetch video title using YouTubeFetcher
            ...
            if (videoId != null) {
                YouTubeFetcher fetcherRelated = new YouTubeFetcher(this);
                fetcherRelated.fetchRelatedVideos(videoId);
            } else {
